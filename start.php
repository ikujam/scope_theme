...
elgg_register_event_handler('init','system','scope_theme_init');

function scope_theme_init() {

	elgg_register_event_handler('pagesetup', 'system', 'scope_theme_pagesetup', 1000);

	// theme specific CSS
	elgg_extend_view('css/elgg', 'scope_theme/css');
	// theme specific CSS
	elgg_extend_view('css/elgg', 'extractability/css');

	
	elgg_register_plugin_hook_handler('head', 'page', 'scope_theme_setup_head');
	...
	elgg_register_js('slidebars', 'mod/scope_theme/lib/slidebars/slidebars.js', 'head');
	elgg_register_css('slidebars', 'mod/scope_theme/lib/slidebars/slidebars.css');
	elgg_register_js('flowplayer', 'mod/scope_theme/lib/flowplayer/flowplayer.min.js', 'head');
	elgg_register_css('flowplayer', 'mod/scope_theme/lib/flowplayer/minimalist.css');
	elgg_register_css('font-awesome', 'mod/scope_theme/lib/font-awesome/css/font-awesome.min.css');

	$base = elgg_get_plugins_path() . 'scope_theme';
 ...
 */
function scope_theme_pagesetup() {
 ...
 * @return array
 */
function scope_theme_setup_head($hook, $type, $data) {
